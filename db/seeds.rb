...
doctor_names = [
  ...
  appointments_data = [
    { date: Date.today, time: "10 AM", reason_for_visit: "Annual check-up", patient_id: 1 , doctor_id: ""},
    { date: Date.today, time: "11 AM", reason_for_visit: "Follow-up for medication", patient_id: 2 , doctor_id: ""},
    { date: Date.tomorrow, time: "2 PM", reason_for_visit: "Initial consultation", patient_id: 3 , doctor_id: ""},
    { date: Date.tomorrow, time: "9 AM", reason_for_visit: "Blood test results review", patient_id: 4 , doctor_id: ""},
    { date: Date.today + 3.days, time: "4 PM", reason_for_visit: "Joint pain evaluation", patient_id: 5 , doctor_id: ""},
    { date: Date.today + 4.days, time: "11 AM", reason_for_visit: "Mental health counseling", patient_id: 6 , doctor_id: ""},
    { date: Date.today + 5.days, time: "3 PM", reason_for_visit: "Diabetes management", patient_id: 7 , doctor_id: ""},
    { date: Date.today + 6.days, time: "1 PM", reason_for_visit: "Headache and dizziness", patient_id: 8 , doctor_id: ""},
    { date: Date.today + 7.days, time: "10 AM", reason_for_visit: "Post-surgery follow-up", patient_id: 9 , doctor_id: ""},
    { date: Date.today + 8.days, time: "2 PM", reason_for_visit: "Hypertension monitoring", patient_id: 10, doctor_id: ""},
    # Additional appointment data
    { date: Date.today, time: "3 PM", reason_for_visit: "Allergy consultation", patient_id: 11, doctor_id: "" },
    { date: Date.today, time: "4 PM", reason_for_visit: "Physical therapy session", patient_id: 12, doctor_id: "" },
    { date: Date.tomorrow, time: "10 AM", reason_for_visit: "Gastroenterology follow-up", patient_id: 13, doctor_id: "" },
    { date: Date.tomorrow, time: "1 PM", reason_for_visit: "Dental cleaning", patient_id: 14, doctor_id: "" },
    { date: Date.today + 3.days, time: "9 AM", reason_for_visit: "Orthopedic evaluation", patient_id: 15, doctor_id: "" },
    { date: Date.today + 3.days, time: "2 PM", reason_for_visit: "Counseling session", patient_id: 16, doctor_id: "" },
    { date: Date.today + 4.days, time: "11 AM", reason_for_visit: "Dermatology consultation", patient_id: 17, doctor_id: "" },
    { date: Date.today + 4.days, time: "3 PM", reason_for_visit: "Eye examination", patient_id: 18, doctor_id: "" },
    { date: Date.today + 5.days, time: "9 AM", reason_for_visit: "Cardiology follow-up", patient_id: 19, doctor_id: "" },
    { date: Date.today + 5.days, time: "2 PM", reason_for_visit: "Nutrition counseling", patient_id: 20, doctor_id: "" },
    { date: Date.today + 6.days, time: "10 AM", reason_for_visit: "Psychiatry session", patient_id: 21, doctor_id: "" },
    { date: Date.today + 6.days, time: "3 PM", reason_for_visit: "Physical therapy session", patient_id: 22, doctor_id: "" },
    { date: Date.today + 7.days, time: "9 AM", reason_for_visit: "Dental check-up", patient_id: 23, doctor_id: "" },
    { date: Date.today + 7.days, time: "1 PM", reason_for_visit: "Orthodontic consultation", patient_id: 24, doctor_id: "" },
    { date: Date.today + 8.days, time: "11 AM", reason_for_visit: "Pulmonology follow-up", patient_id: 25, doctor_id: "" },
    { date: Date.today + 8.days, time: "3 PM", reason_for_visit: "Endocrinology consultation", patient_id: 26, doctor_id: "" },
    { date: Date.today + 9.days, time: "10 AM", reason_for_visit: "Ophthalmology appointment", patient_id: 27, doctor_id: "" },
    { date: Date.today + 9.days, time: "2 PM", reason_for_visit: "ENT consultation", patient_id: 28, doctor_id: "" },
    { date: Date.today + 10.days, time: "9 AM", reason_for_visit: "Gynecology check-up", patient_id: 29, doctor_id: "" },
    { date: Date.today + 10.days, time: "1 PM", reason_for_visit: "Physical therapy session", patient_id: 30, doctor_id: "" },
    { date: Date.today + 11.days, time: "3 PM", reason_for_visit: "Urology consultation", patient_id: 31, doctor_id: "" },
    { date: Date.today + 11.days, time: "4 PM", reason_for_visit: "Dental extraction", patient_id: 32, doctor_id: "" },
    { date: Date.today + 12.days, time: "11 AM", reason_for_visit: "Physical therapy session", patient_id: 33, doctor_id: "" },
    { date: Date.today + 12.days, time: "2 PM", reason_for_visit: "Pediatric check-up", patient_id: 34, doctor_id: "" },
    { date: Date.today + 13.days, time: "9 AM", reason_for_visit: "Psychology session", patient_id: 35, doctor_id: "" },
    { date: Date.today + 13.days, time: "1 PM", reason_for_visit: "Dermatology follow-up", patient_id: 36, doctor_id: "" },
    { date: Date.today + 14.days, time: "10 AM", reason_for_visit: "Orthopedic consultation", patient_id: 37, doctor_id: "" },
    { date: Date.today + 14.days, time: "3 PM", reason_for_visit: "Cardiology check-up", patient_id: 38, doctor_id: "" },
    { date: Date.today + 15.days, time: "9 AM", reason_for_visit: "ENT follow-up", patient_id: 39, doctor_id: "" },
    { date: Date.today + 15.days, time: "1 PM", reason_for_visit: "Nutrition counseling", patient_id: 40, doctor_id: "" },
    { date: Date.today + 16.days, time: "11 AM", reason_for_visit: "Gynecology consultation", patient_id: 41, doctor_id: "" },
    { date: Date.today + 16.days, time: "2 PM", reason_for_visit: "Ophthalmology appointment", patient_id: 42, doctor_id: "" },
    { date: Date.today + 17.days, time: "10 AM", reason_for_visit: "Dental cleaning", patient_id: 43, doctor_id: "" },
    { date: Date.today + 17.days, time: "3 PM", reason_for_visit: "Psychiatry session", patient_id: 44, doctor_id: "" },
    { date: Date.today + 18.days, time: "9 AM", reason_for_visit: "Physical therapy session", patient_id: 45, doctor_id: "" }
