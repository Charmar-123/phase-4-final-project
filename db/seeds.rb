...
doctor_names = [
  ...
  patients_data = [
    { name: "John Doe", date_of_birth: "1988-07-31", history: "Hypertension, Diabetes" },
    { name: "Jane Smith", date_of_birth: "1981-07-31", history: "Asthma, Allergies" },
    { name: "Michael Johnson", date_of_birth: "1995-07-31", history: "None" },
    { name: "Emily Davis", date_of_birth: "1973-07-31", history: "Heart Disease, High Cholesterol" },
    { name: "David Wilson", date_of_birth: "1958-07-31", history: "Arthritis, Hypothyroidism" },
    { name: "Sophia Brown", date_of_birth: "2004-07-31", history: "Anxiety, Depression" },
    { name: "Oliver Taylor", date_of_birth: "1967-07-31", history: "Type 2 Diabetes, Obesity" },
    { name: "Ava Martinez", date_of_birth: "1991-07-31", history: "Migraines, Insomnia" },
    { name: "Emma Anderson", date_of_birth: "1976-07-31", history: "Cancer Survivor" },
    { name: "Liam Thomas", date_of_birth: "1953-07-31", history: "Hypertension, Osteoporosis" },
    { name: "Olivia Wilson", date_of_birth: "1998-07-31", history: "PCOS, Thyroid Disorders" },
    { name: "Noah Davis", date_of_birth: "1992-07-31", history: "Celiac Disease" },
    { name: "Isabella Lee", date_of_birth: "2009-07-31", history: "Allergies, Asthma" },
    { name: "James Martinez", date_of_birth: "1961-07-31", history: "Chronic Obstructive Pulmonary Disease (COPD)" },
    { name: "Sophia Miller", date_of_birth: "1985-07-31", history: "Rheumatoid Arthritis, Fibromyalgia" },
    { name: "Ethan Johnson", date_of_birth: "1976-07-31", history: "Type 1 Diabetes" },
    { name: "Mia Clark", date_of_birth: "1994-07-31", history: "Anemia" },
    { name: "Aiden Young", date_of_birth: "2015-07-31", history: "ADHD" },
    { name: "Charlotte Lewis", date_of_birth: "1963-07-31", history: "Osteoarthritis" },
    { name: "Henry Moore", date_of_birth: "1977-07-31", history: "Depression, Anxiety" },
    { name: "Lily Davis", date_of_birth: "1990-07-31", history: "Asthma, allergies." },
    { name: "Jacob Thompson", date_of_birth: "1956-07-31", history: "Type 2 diabetes, hypertension." },
    { name: "Grace White", date_of_birth: "1971-07-31", history: "Migraine headaches, depression." },
    { name: "Benjamin Martin", date_of_birth: "1982-07-31", history: "Gastroesophageal reflux disease (GERD)." },
    { name: "Abigail Turner", date_of_birth: "1999-07-31", history: "Anxiety disorder, panic attacks." },
    { name: "Elijah Harris", date_of_birth: "1986-07-31", history: "High cholesterol, obesity." },
    { name: "Elizabeth Walker", date_of_birth: "1962-07-31", history: "Hypothyroidism, osteoarthritis." },
    { name: "Carter Allen", date_of_birth: "1992-07-31", history: "Crohn disease, ulcerative colitis." },
    { name: "Sofia Young", date_of_birth: "1997-07-31", history: "Depression, eating disorder." },
    { name: "Sebastian Rodriguez", date_of_birth: "1984-07-31", history: "Hypertension, sleep apnea." },
    { name: "Avery Lopez", date_of_birth: "1974-07-31", history: "Rheumatoid arthritis, fibromyalgia." },
    { name: "Scarlett Hill", date_of_birth: "1994-07-31", history: "Endometriosis, polycystic ovary syndrome (PCOS)." },
    { name: "Grayson Green", date_of_birth: "1978-07-31", history: "Asthma, allergies." },
    { name: "Zoe Adams", date_of_birth: "1991-07-31", history: "Migraine headaches, anxiety." },
    { name: "Jackson Mitchell", date_of_birth: "1966-07-31", history: "Type 2 diabetes, hypertension." },
    { name: "Luna Carter", date_of_birth: "1995-07-31", history: "Depression, bipolar disorder." },
    { name: "Elijah Turner", date_of_birth: "1980-07-31", history: "Obesity, sleep apnea." },
    { name: "Mila Rivera", date_of_birth: "1990-07-31", history: "Thyroid disorder, osteoporosis." },
    { name: "Aiden Powell", date_of_birth: "1973-07-31", history: "High cholesterol, heart disease." },
    { name: "Aria Collins", date_of_birth: "1987-07-31", history: "Anxiety disorder, panic attacks." },
    { name: "Matthew Stewart", date_of_birth: "1961-07-31", history: "Osteoarthritis, hypertension." },
    { name: "Layla Murphy", date_of_birth: "1993-07-31", history: "Asthma, allergies." },
    { name: "Lucas Rivera", date_of_birth: "1976-07-31", history: "Type 2 diabetes, obesity." },

  ]
  
  patients_data.each do |patient|
    Patient.create(name: patient[:name], date_of_birth: patient[:date_of_birth], history: patient[:history], email: patient[:name].sub(/^(\w)\w*\s(\w+)/, '\1\2@ptn.sgh.com').downcase,
